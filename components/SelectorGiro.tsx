            ...
            <div className="sel-viewport">
              ...
              <div className={`sel-screen${active === 'restaurante' ? ' active' : ''}`} id="sel-restaurante">
                ...
                <div className="sr-hero">
                  <div className="sr-hero-bg" style={{backgroundImage:"linear-gradient(160deg,rgba(15,12,9,.04) 0%,rgba(201,169,110,.12) 38%,rgba(15,12,9,.96) 100%),url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&q=85')"}} />
              ...
              <div className={`sel-screen${active === 'barberia' ? ' active' : ''}`} id="sel-barberia">
                ...
                <div className="sb-hero">
                  <div className="sb-hero-bg" style={{backgroundImage:"linear-gradient(160deg,rgba(10,10,10,.02) 0%,rgba(10,10,10,.45) 50%,rgba(10,10,10,.98) 100%),url('https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=800&q=85')"}} />
              ...
              <div className={`sel-screen${active === 'pasteleria' ? ' active' : ''}`} id="sel-pasteleria">
                ...
                <div className="sp-hero"><div className="sp-hero-bg" style={{backgroundImage:"linear-gradient(to bottom,rgba(61,31,14,.03) 0%,rgba(212,132,62,.14) 45%,rgba(61,31,14,.92) 100%),url('https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&q=85')"}} /><div className="sp-hero-body"><div className="sp-eyebrow">Repostería artesanal · CDMX · 2020</div><div className="sp-hl">Hecho con <em>amor.</em></div><div className="sp-btn">Ver catálogo completo</div></div></div>
              ...
              <div className={`sel-screen${active === 'taller' ? ' active' : ''}`} id="sel-taller">
                ...
                <div className="st-hero"><div className="st-hero-bg" style={{backgroundImage:"linear-gradient(180deg,rgba(13,17,23,.06) 0%,rgba(13,17,23,.48) 48%,rgba(13,17,23,.99) 100%),url('https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=800&q=85')"}} /><div className="st-hero-body"><div className="st-eyebrow">Mecánica automotriz · GDL · Desde 2005</div><div className="st-hl">Tu auto, en manos <span>expertas.</span></div><div className="st-btns"><div className="st-btn-p">Agendar revisión</div><div className="st-btn-s">Ver servicios</div></div></div></div>
